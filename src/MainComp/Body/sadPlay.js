...
const sadPlay =async ()=>{
    console.log("eventlistner hal gya");
    const options = {
        method: 'GET',
        headers: {
      ...
      const url = "https://shazam.p.rapidapi.com/search?term="+`sad`+"&locale=en-US&offset=0&limit=5";
      ...
      if(actData != undefined){
         ...
         ReactDOM.render(
            ...
            document.getElementById("b-SP-wrap")
         )
      }
    }

    export default sadPlay;